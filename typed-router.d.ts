...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'pages-account-settings-tab-backup': RouteRecordInfo<'pages-account-settings-tab-backup', '/pages/account-settings/:tab-backup', { tab: ParamValue<true> }, { tab: ParamValue<false> }>,
