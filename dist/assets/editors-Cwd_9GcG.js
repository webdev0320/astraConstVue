import{u as g,S as v,P as c,U as k,E as b}from"./index-D4Zgl5G2.js";import{T as C}from"./index-DyFGGhX8.js";import{V as n}from"./VChip-CV2e7BDJ.js";import{V as y}from"./VDivider-Ri7KQT1B.js";import{c as u,o as d,l as $,b as i,m as e,e as r,t as s,r as A,aW as x,f as E}from"./index-KMYiuhTK.js";import{_ as B}from"./AppCardCode-QLl-ML97.js";import{_ as V}from"./TiptapEditor-DH1LPc6u.js";import{V as w,a as m}from"./VRow-KEsfQD-j.js";import"./VSlideGroup-BEFf0i5L.js";import"./VAvatar-IECEzw6A.js";import"./VImg-Q7xwtwO7.js";import"./index-N0XPubPM.js";import"./vue3-perfect-scrollbar-D4QsfqYq.js";import"./VCard-C-xjzesx.js";import"./VCardText-CAltGW5D.js";/* empty css              */const H={class:"border pa-2 rounded custom-editor"},I={key:0,class:"d-flex flex-wrap gap-x-4 gap-y-2 mb-2"},T={__name:"DemoEditorCustomEditor",setup(p){const t=g({content:`
        <h2>
          Hi there,
        </h2>
        <p>
...
`);return(f,o)=>{const l=V;return d(),u("div",null,[i(l,{modelValue:e(t),"onUpdate:modelValue":o[0]||(o[0]=a=>x(t)?t.value=a:null),class:"border rounded basic-editor"},null,8,["modelValue"])])}}},D={},S={},X={__name:"editors",setup(p){return(t,f)=>{const o=q,l=B,a=T;return d(),E(w,null,{default:r(()=>[i(m,{cols:"12"},{default:r(()=>[i(l,{title:"Basic Editor",code:D},{default:r(()=>[i(o)]),_:1},8,["code"])]),_:1}),i(m,{cols:"12"},{default:r(()=>[i(l,{title:"Custom Editor",code:S},{default:r(()=>[i(a)]),_:1},8,["code"])]),_:1})]),_:1})}}};export{X as default};
