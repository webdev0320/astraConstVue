import{a as I}from"./index-NIGUFBhG.js";import{M as O,Q as g,i as j,r as x,G as F,c as _,d,f as T,l as L,b as a,e as s,m as w,j as M,o as m,t as n,ak as H,v as i}from"./index-DIY64fxg.js";import"./useConfirmDialog-lr5cfE6i.js";import{V as E,b as q}from"./VCard-oupJveU2.js";import{V as z}from"./VDataTable-y7lots43.js";import{V as N}from"./VCardText-CTkf0C-c.js";import{V as p}from"./VRow-Dzi1A7mn.js";import{V as l}from"./VCol-DOAyfIu3.js";import{V as Y}from"./VDivider-YxYw9bay.js";import{V as G}from"./VAlert-CKcuvzuy.js";import{V as K}from"./VSkeletonLoader-B6zbpByx.js";import"./createSimpleFunctional-Dwg9PHDE.js";import"./VAvatar-C-IKLaue.js";import"./index-D01_KlhT.js";import"./VSelect-BLnZQW8_.js";import"./VTextField-YMi6pQJA.js";import"./VField-BiBWCWZC.js";import"./VInput-qUVYKXCT.js";import"./forwardRefs-D3j0TLhE.js";import"./VList-cxZDjE0W.js";import"./ssrBoot-BK8IF2Y6.js";import"./dialog-transition-Cuoiw-RJ.js";import"./VMenu-CdP9Gme9.js";import"./VOverlay-DnvDRZ1m.js";import"./scopeId-BfPBIQH4.js";import"./VSelectionControl-DR9ue_C_.js";import"./VChip-C8NRWZyr.js";import"./VTable-i2bIgNWB.js";/* empty css              */const U={class:"page-wrap"},Q={class:"topbar"},J={class:"right"},Z={key:2,class:"",id:"printArea"},W={class:"font-weight-bold"},X={class:"font-weight-bold"},tt={class:"font-weight-bold"},et={class:"font-weight-bold"},st={class:"font-weight-bold"},dt={class:"font-weight-bold"},at={class:"font-weight-bold"},ot={class:"font-weight-bold"},rt={class:"font-weight-bold"},it={class:"font-weight-bold"},lt={class:"font-weight-bold"},nt={class:"font-weight-bold"},ct={class:"font-weight-bold"},pt={class:"font-weight-bold"},mt={class:"font-weight-bold"},ft={key:3},A="/src/assets/images/logos/astra-logo.png",vt={__name:"show",setup(ut){const k="https://dm.kreashionsoftwarehouse.com/astraConst/public/api",R=j();M();const D=g(()=>R.params.id),u=x(!0),f=x(""),r=x(null),$=[{title:"S/N",key:"sn",width:"70px",align:"center"},{title:"Asset Name & Code",key:"asset"},{title:"DESCRIPTION",key:"description"},{title:"QTY",key:"qty",width:"80px",align:"center"},{title:"REMARKS",key:"remarks"}],C=t=>{const o=`; ${document.cookie}`.split(`; ${t}=`);return o.length===2?o.pop().split(";").shift():null},S=new Intl.DateTimeFormat("en-GB",{timeZone:"Asia/Karachi"}),c=t=>{try{if(!t)return"—";const e=new Date(t);return isNaN(e)?"—":S.format(e)}catch{return"—"}},b=t=>{try{if(!t)return"—";const e=new Date(t);return isNaN(e)?"—":e.toLocaleTimeString("en-GB",{hour:"2-digit",minute:"2-digit",timeZone:"Asia/Karachi"})}catch{return"—"}},y=t=>t?`#${t}`:"—",V=g(()=>{var t;return Array.isArray((t=r.value)==null?void 0:t.items)?r.value.items:[]});F(async()=>{var t,e;u.value=!0,f.value="",r.value=null;try{const o=C("accessToken");if(!o)throw new Error("Access token is missing. Please log in.");const h=decodeURIComponent(o),{data:v}=await I.get(`${k}/asset-transfers/${D.value}`,{headers:{Authorization:`Bearer ${h}`,Accept:"application/json"}});r.value=(v==null?void 0:v.data)??v??null}catch(o){console.error(o),f.value=((e=(t=o.response)==null?void 0:t.data)==null?void 0:e.message)||"Failed to load details."}finally{u.value=!1}});const P=g(()=>V.value.map(t=>({sn:"",brand:t==null?void 0:t.assetName,description:t==null?void 0:t.description,qty:t==null?void 0:t.qty,remarks:t==null?void 0:t.remarks,asset_id:t==null?void 0:t.asset_id,assetName:t==null?void 0:t.assetName,assetCode:t==null?void 0:t.assetCode}))),B=()=>{const t=r.value,e=window.open("","","width=1000,height=700");e.document.write(`
    <html>
      <head>
    ...
    .header-table{
      ...
      <table>
        ...
        <tr>
          ...
          <td>Time<br><b>${b(t.transfer_time)}</b></td>
        </tr>
        <tr>
