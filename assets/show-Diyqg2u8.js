import{a as I}from"./index-NIGUFBhG.js";import{M as O,Q as g,i as j,r as x,G as F,c as _,d,f as T,l as L,b as a,e as s,m as w,j as M,o as m,t as n,ak as H,v as i}from"./index-ENKyIvdp.js";import"./useConfirmDialog-BOqYN4lX.js";import{V as E,b as q}from"./VCard-DjyApLVY.js";import{V as z}from"./VDataTable-Cz10M0e4.js";import{V as N}from"./VCardText-CBMytqK3.js";import{V as p}from"./VRow-S6q9wfCG.js";import{V as l}from"./VCol-Co1Mg1zH.js";import{V as Y}from"./VDivider-c_a1wYat.js";import{V as G}from"./VAlert-DJmr9iPx.js";import{V as K}from"./VSkeletonLoader-C9elCpGR.js";import"./createSimpleFunctional-D3oAOD1n.js";import"./VAvatar-lQBawjWh.js";import"./index-B66Vfv_b.js";import"./VSelect-C1V4WH2k.js";import"./VTextField-DUGliRkr.js";import"./VField-BKJnd5Xd.js";import"./VInput-GW05C54y.js";import"./forwardRefs-D3j0TLhE.js";import"./VList-OkPxz3KR.js";import"./ssrBoot-SzUPGlbU.js";import"./dialog-transition-x5Ajgs6m.js";import"./VMenu-DWol_8mN.js";import"./VOverlay-Dd4gFh8U.js";import"./scopeId-CM5aYpzx.js";import"./VSelectionControl-DvDCde6a.js";import"./VChip-BYIas7FG.js";import"./VTable-BEXurmIA.js";/* empty css              */const U={class:"page-wrap"},Q={class:"topbar"},J={class:"right"},Z={key:2,class:"",id:"printArea"},W={class:"font-weight-bold"},X={class:"font-weight-bold"},tt={class:"font-weight-bold"},et={class:"font-weight-bold"},st={class:"font-weight-bold"},dt={class:"font-weight-bold"},at={class:"font-weight-bold"},ot={class:"font-weight-bold"},rt={class:"font-weight-bold"},it={class:"font-weight-bold"},lt={class:"font-weight-bold"},nt={class:"font-weight-bold"},ct={class:"font-weight-bold"},pt={class:"font-weight-bold"},mt={class:"font-weight-bold"},ft={key:3},A="/src/assets/images/logos/astra-logo.png",vt={__name:"show",setup(bt){const k="http://127.0.0.1:8000/api",R=j();M();const D=g(()=>R.params.id),b=x(!0),f=x(""),r=x(null),$=[{title:"S/N",key:"sn",width:"70px",align:"center"},{title:"Asset Name & Code",key:"asset"},{title:"DESCRIPTION",key:"description"},{title:"QTY",key:"qty",width:"80px",align:"center"},{title:"REMARKS",key:"remarks"}],C=t=>{const o=`; ${document.cookie}`.split(`; ${t}=`);return o.length===2?o.pop().split(";").shift():null},S=new Intl.DateTimeFormat("en-GB",{timeZone:"Asia/Karachi"}),c=t=>{try{if(!t)return"—";const e=new Date(t);return isNaN(e)?"—":S.format(e)}catch{return"—"}},u=t=>{try{if(!t)return"—";const e=new Date(t);return isNaN(e)?"—":e.toLocaleTimeString("en-GB",{hour:"2-digit",minute:"2-digit",timeZone:"Asia/Karachi"})}catch{return"—"}},y=t=>t?`#${t}`:"—",V=g(()=>{var t;return Array.isArray((t=r.value)==null?void 0:t.items)?r.value.items:[]});F(async()=>{var t,e;b.value=!0,f.value="",r.value=null;try{const o=C("accessToken");if(!o)throw new Error("Access token is missing. Please log in.");const h=decodeURIComponent(o),{data:v}=await I.get(`${k}/asset-transfers/${D.value}`,{headers:{Authorization:`Bearer ${h}`,Accept:"application/json"}});r.value=(v==null?void 0:v.data)??v??null}catch(o){console.error(o),f.value=((e=(t=o.response)==null?void 0:t.data)==null?void 0:e.message)||"Failed to load details."}finally{b.value=!1}});const P=g(()=>V.value.map(t=>({sn:"",brand:t==null?void 0:t.assetName,description:t==null?void 0:t.description,qty:t==null?void 0:t.qty,remarks:t==null?void 0:t.remarks,asset_id:t==null?void 0:t.asset_id,assetName:t==null?void 0:t.assetName,assetCode:t==null?void 0:t.assetCode}))),B=()=>{const t=r.value,e=window.open("","","width=1000,height=700");e.document.write(`
    <html>
      <head>
