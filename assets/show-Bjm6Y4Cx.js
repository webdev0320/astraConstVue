import{a as I}from"./index-NIGUFBhG.js";import{M as O,Q as h,i as j,r as x,G as F,c as _,d,f as T,l as L,b as a,e as s,m as w,j as M,o as m,t as n,ak as H,v as i}from"./index-DLkD3pXm.js";import"./useConfirmDialog-kLKFQbhR.js";import{V as E,b as q}from"./VCard-CYH96V5B.js";import{V as z}from"./VDataTable-D-2gSpHB.js";import{V as N}from"./VCardText-BETlkQCq.js";import{V as p}from"./VRow-CKsltyzr.js";import{V as l}from"./VCol-BYefOY2E.js";import{V as Y}from"./VDivider-DvuxysEB.js";import{V as G}from"./VAlert-Mfc01qP8.js";import{V as K}from"./VSkeletonLoader-BBvaQVv1.js";import"./createSimpleFunctional-UXYpYKXM.js";import"./VAvatar-DAUQa38r.js";import"./index-BNcJp3w6.js";import"./VSelect-BlhKtJOI.js";import"./VTextField-BYw78dTc.js";import"./VField-CjVX5eLh.js";import"./VInput-Dgdq4MD1.js";import"./forwardRefs-D3j0TLhE.js";import"./VList-OVvHsOjw.js";import"./ssrBoot-C2_RswAd.js";import"./dialog-transition-B8tDjyAz.js";import"./VMenu-BiZjLC3H.js";import"./VOverlay-DKMvQ4a4.js";import"./scopeId-TVOvXLGJ.js";import"./VSelectionControl-CzCEe_Bg.js";import"./VChip-DxFAIVeh.js";import"./VTable-6a4SMlck.js";/* empty css              */const U={class:"page-wrap"},Q={class:"topbar"},J={class:"right"},Z={key:2,class:"",id:"printArea"},W={class:"font-weight-bold"},X={class:"font-weight-bold"},tt={class:"font-weight-bold"},et={class:"font-weight-bold"},st={class:"font-weight-bold"},dt={class:"font-weight-bold"},at={class:"font-weight-bold"},ot={class:"font-weight-bold"},rt={class:"font-weight-bold"},it={class:"font-weight-bold"},lt={class:"font-weight-bold"},nt={class:"font-weight-bold"},ct={class:"font-weight-bold"},pt={class:"font-weight-bold"},mt={class:"font-weight-bold"},ft={key:3},A="/src/assets/images/logos/astra-logo.png",vt={__name:"show",setup(bt){const k="https://astracontsbackend.taxaccolega.co.uk/astraConst/public/api/login",R=j();M();const D=h(()=>R.params.id),b=x(!0),f=x(""),r=x(null),$=[{title:"S/N",key:"sn",width:"70px",align:"center"},{title:"Asset Name & Code",key:"asset"},{title:"DESCRIPTION",key:"description"},{title:"QTY",key:"qty",width:"80px",align:"center"},{title:"REMARKS",key:"remarks"}],C=t=>{const o=`; ${document.cookie}`.split(`; ${t}=`);return o.length===2?o.pop().split(";").shift():null},S=new Intl.DateTimeFormat("en-GB",{timeZone:"Asia/Karachi"}),c=t=>{try{if(!t)return"—";const e=new Date(t);return isNaN(e)?"—":S.format(e)}catch{return"—"}},u=t=>{try{if(!t)return"—";const e=new Date(t);return isNaN(e)?"—":e.toLocaleTimeString("en-GB",{hour:"2-digit",minute:"2-digit",timeZone:"Asia/Karachi"})}catch{return"—"}},y=t=>t?`#${t}`:"—",V=h(()=>{var t;return Array.isArray((t=r.value)==null?void 0:t.items)?r.value.items:[]});F(async()=>{var t,e;b.value=!0,f.value="",r.value=null;try{const o=C("accessToken");if(!o)throw new Error("Access token is missing. Please log in.");const g=decodeURIComponent(o),{data:v}=await I.get(`${k}/asset-transfers/${D.value}`,{headers:{Authorization:`Bearer ${g}`,Accept:"application/json"}});r.value=(v==null?void 0:v.data)??v??null}catch(o){console.error(o),f.value=((e=(t=o.response)==null?void 0:t.data)==null?void 0:e.message)||"Failed to load details."}finally{b.value=!1}});const P=h(()=>V.value.map(t=>({sn:"",brand:t==null?void 0:t.assetName,description:t==null?void 0:t.description,qty:t==null?void 0:t.qty,remarks:t==null?void 0:t.remarks,asset_id:t==null?void 0:t.asset_id,assetName:t==null?void 0:t.assetName,assetCode:t==null?void 0:t.assetCode}))),B=()=>{const t=r.value,e=window.open("","","width=1000,height=700");e.document.write(`
    <html>
      <head>
